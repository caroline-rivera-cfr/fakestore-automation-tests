...
describe('Fake Store - Products API', () => {
  ...
  it('Validates there are 20 products', () => {
  ...
  it('Validates there are 6 products with category electronics and print them', () => {
    ProductsApi.getAllProducts().then((products) => {
  ...
  it('Validates there are 2 electronics with rate > 4', () => {
    ProductsApi.getAllProducts().then((products) => {
